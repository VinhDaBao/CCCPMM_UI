...
import { getAllAssetsApi, uploadAssetApi, getWorkspaceTagsApi, updateAssetApi, deleteAssetApi } from '../util/api';
    ...
    return (
        ...
        >
            <div style={{
                ...
                {uiType === "image" ? (
                    <img src={data.url} alt={data.fileName} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                ) : (
                    ...
                    <div>
                        ...
                        <div style={{ padding: '16px', background: 'var(--bg-hover)', borderRadius: 8, textAlign: 'center' }}>
                            {selectedAsset.type === 'IMAGE' ? (
                                <img src={selectedAsset.url} alt={selectedAsset.fileName} style={{ maxWidth: "100%", maxHeight: "350px", objectFit: "contain", borderRadius: 8, boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }} />
                            ) : selectedAsset.type === 'AUDIO' ? (
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16, padding: '20px 0' }}>
                                    <Icon name="music" size={48} color="var(--accent-ice)" />
                                    <audio controls autoPlay src={selectedAsset.url} style={{ width: "100%", outline: "none" }} controlsList="nodownload" />
                                </div>
