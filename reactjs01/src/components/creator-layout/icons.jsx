...
const Icon = ({ name, size = 16, color = "currentColor", className = "" }) => {
  const icons = {
    ...
    cpu: <><rect x="9" y="9" width="6" height="6"/><path d="M15 9V3h-6v6M15 15v6H9v-6M9 9H3v6h6M21 9h-6v6h6M12 3v18"/></>,
    send: <><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></>,
    copy: <><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></>,
    wand: <><path d="m15 4-8 8 3 3 8-8-3-3z"/><path d="m2 22 6-6"/><path d="M5 2v4M2 5h4M18 16v4M16 18h4"/></>,
